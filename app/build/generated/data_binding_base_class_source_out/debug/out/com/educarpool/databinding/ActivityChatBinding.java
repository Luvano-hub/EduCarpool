...
public final class ActivityChatBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton btnHandshake;
  ...
  private ActivityChatBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnBack,
      @NonNull ImageButton btnCall, @NonNull ImageButton btnHandshake, @NonNull ImageButton btnSend,
      @NonNull TextInputEditText etMessage, @NonNull RecyclerView recyclerMessages,
      @NonNull TextView tvUserName) {
    this.rootView = rootView;
    this.btnBack = btnBack;
    this.btnCall = btnCall;
    this.btnHandshake = btnHandshake;
  ...
  public static ActivityChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_handshake;
      ImageButton btnHandshake = ViewBindings.findChildViewById(rootView, id);
      if (btnHandshake == null) {
        break missingId;
      }
      ...
      return new ActivityChatBinding((LinearLayout) rootView, btnBack, btnCall, btnHandshake,
          btnSend, etMessage, recyclerMessages, tvUserName);
    }
